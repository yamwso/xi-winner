...
public class OrderServiceImpl implements OrderService {
    ...
    @Autowired
    OrderDetialRepository orderDetialRepository;
    @Autowired
    ...
    public OrderDTO create(OrderDTO orderDTO) {
        ...
        //查询商品（数量，价格）
        for(OrderDetail orderDetial:orderDTO.getOrderDetailList()){
            ProductInfo productInfo = productService.findOne(orderDetial.getProductId());
            if(productInfo==null){
            ...
            orderDetial.setDetailId(KeyUtil.genUniqueKey());
            orderDetial.setOrderId(orderId);
            orderDetialRepository.save(orderDetial);
        }
